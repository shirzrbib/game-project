...
const infoP = document.getElementById("infoP") as HTMLParagraphElement;
const takeCardBtnUser1 = document.getElementById(
  "takeCardBtnUser1"
) as HTMLDivElement;
const takeCardBtnUser2 = document.getElementById(
  "takeCardBtnUser2"
) as HTMLDivElement;
const card1Div = document.getElementById("card1Div") as HTMLDivElement;
const card2Div = document.getElementById("card2Div") as HTMLDivElement;
const user1div = document.getElementById("user1div") as HTMLDivElement;
const user2div = document.getElementById("user2div") as HTMLDivElement;
let user1points = document.getElementById("user1points") as HTMLDivElement;
let user2points = document.getElementById("user2points") as HTMLDivElement;
let user1sumOfCards = document.getElementById(
  "user1sumOfCards"
) as HTMLParagraphElement;
let user2sumOfCards = document.getElementById(
  "user2sumOfCards"
) as HTMLParagraphElement;
const winnerDiv = document.getElementById("winnerDiv") as HTMLDivElement;
...
const user1cards: Card[] = [];
const user2cards: Card[] = [];
...
let card1img: HTMLImageElement;
let card2img: HTMLImageElement;

function createUser1Card(arr: Card[]) {
  card1Div.innerHTML = "";
...
function createUser2Card(arr: Card[]) {
  card2Div.innerHTML = "";
...
function checkWhosWin() {
  if (cardsArray.length <= 52) {
    ...
    if (cardsArray[currentCard].num > cardsArray[currentCard + 1].num) {
      for (
        let i = 0;
        i <= currentCard + 1 && currentCard + 1 <= cardsArray.length;
        i++
      ) {
...
function continueGameOneVSOne() {
  if (user1cards.length - 1 > 0 && user2cards.length - 1 > 0) {
    ...
    if (user1cards[currentCard].num > user2cards[currentCard].num) {
      for (
        let i = 0;
        i <= currentCard && currentCard + 1 <= user1cards.length;
        i++
      ) {
      ...
      for (
        let i = 0;
        i <= currentCard && currentCard + 1 <= user2cards.length;
        i++
      ) {
